...
public class AssetClassTest extends AbstractDomainTestCase {
    
    @Test
    public void newly_created_AssetClass_is_always_active() {
        final AssetClass vehicle = co(AssetClass.class).findByKey("Vehicle");
    ...
    protected void populateDomain() {
        ...
        save(new_(AssetClass.class).setName("Vehicle").setDesc("All vehicles asset class"));
    }
